...
# Self-Consistency Prompting: The model is asked to generate multiple responses and then select the most consistent one


# Persona Prompting: The model is given a specific persona to adopt while responding